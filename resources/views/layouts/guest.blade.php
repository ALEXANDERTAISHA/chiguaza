...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-100 antialiased">
        ...
        <style>
            ...
            .auth-card p, .auth-card label, .auth-card span, .auth-card h1, .auth-card h2, .auth-card h3, .auth-card h4, .auth-card h5, .auth-card h6 { color:#ffffff !important; }
            .auth-card input[type="email"], .auth-card input[type="password"] { color:#0f172a !important; }
            .auth-card input::placeholder { color: rgba(248,250,252,0.7) !important; }
