                ...
                <div style="background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.08); box-shadow: 0 30px 80px rgba(0,0,0,0.25); border-radius: 36px; overflow:hidden; padding: 2rem; position:relative; backdrop-filter: blur(16px);">
                    <div style="display:flex; justify-content:space-between; align-items:center; gap:1rem; margin-bottom:1.5rem;">
                        <div>
                            ...
                            <h3 style="margin:0.6rem 0 0; font-size:2.35rem; color:#ffffff; line-height:1.05;">{{ $autoridad->frase }}</h3>
                        </div>
                        <div style="width:68px; height:68px; border-radius:22px; background: rgba(37,99,235,0.15); display:flex; align-items:center; justify-content:center;">
                    ...
                    <div style="display:grid; gap:1rem;">
                        <div style="position:relative; border-radius:32px; overflow:hidden; height:420px;">
                            ...
                            <div style="position:absolute; left:1.5rem; bottom:1.5rem; right:1.5rem; display:flex; justify-content:space-between; align-items:flex-end; gap:1rem;">
                                <div style="background: rgba(15,23,42,0.75); padding:1rem 1.2rem; border-radius:24px; border:1px solid rgba(255,255,255,0.1); backdrop-filter: blur(8px);">
                                    <p style="margin:0; font-size:0.78rem; color:#94a3b8; letter-spacing:0.14em; text-transform:uppercase;">Experiencia</p>
                                    <strong style="display:block; margin-top:0.35rem; font-size:1.45rem; color:#ffffff;">{{ $autoridad->anio_experiencia }} años</strong>
                                </div>
                                <a href="{{ $autoridad->url_video }}" class="video-popup" style="display:inline-flex; align-items:center; gap:0.75rem; padding:0.85rem 1.2rem; border-radius:999px; background: #22c55e; color:#0f172a; font-weight:700; text-decoration:none; box-shadow: 0 18px 32px rgba(34,197,94,0.26);">
                                    <span class="fa fa-play" style="font-size:0.92rem;"></span>
                                    Ver video
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-xl-6">
                <div style="position:relative; z-index:1;">
                    <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem; margin-bottom:1.4rem;">
                        <div>
                            <span style="display:inline-block; font-size:0.9rem; letter-spacing:0.22em; text-transform:uppercase; color:#7c3aed;">Bienvenido a {{ config('app.name') }}</span>
                            <p style="margin:0.75rem 0 0; color:#e2e8f0; font-size:1rem; line-height:1.9; max-width:680px;">Un gobierno que avanza con fuerza, transparencia y servicios pensados para el desarrollo de toda la comunidad.</p>
                        </div>
                        <div style="width:54px; height:54px; border-radius:16px; background: rgba(37,99,235,0.14); display:flex; align-items:center; justify-content:center;">
                            <span class="fa fa-arrow-up-right" style="color:#60a5fa; font-size:1.2rem;"></span>
                        </div>
                    </div>

                    <div style="background:#0d1724; border:1px solid rgba(96,165,250,0.12); border-radius:32px; padding:1.75rem; margin-bottom:1.75rem;">
                        <div style="display:flex; justify-content:space-between; align-items:center; gap:1rem; margin-bottom:1.2rem;">
                            <div>
                                <span style="font-size:0.85rem; color:#94a3b8; text-transform:uppercase; letter-spacing:0.18em;">Gestión</span>
                                <h3 style="margin:0.45rem 0 0; color:#ffffff; font-size:1.8rem;">{{ $autoridad->anio_experiencia }} años</h3>
                            </div>
                            <span style="background:#18334d; color:#7dd3fc; border-radius:999px; padding:0.75rem 1rem; font-weight:700;">100% obras</span>
                        </div>
                        <div style="height:14px; border-radius:999px; background: rgba(255,255,255,0.08); overflow:hidden;">
