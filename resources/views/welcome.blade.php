...
<section class="services-one" style="background: linear-gradient(135deg, #081f33 0%, #0e395a 100%); padding: 90px 0; position: relative; overflow: hidden; color: #f8fafc;">
    ...
    <div class="container" style="position:relative; z-index:1;">
        <div class="row gx-5 align-items-center">
            <div class="col-xl-5">
                <div style="background: rgba(255,255,255,0.08); border:1px solid rgba(255,255,255,0.14); border-radius:40px; padding:2.2rem; box-shadow: 0 34px 90px rgba(0,0,0,0.24); backdrop-filter: blur(16px); overflow:hidden; position:relative;">
                    <div style="position:absolute; inset:0; background: linear-gradient(180deg, rgba(255,255,255,0.04), transparent 70%); pointer-events:none;"></div>
                    <div style="position:relative; z-index:1; display:flex; flex-direction:column; gap:1.5rem;">
                        <div style="display:flex; align-items:center; gap:1rem;">
                            <div style="width:60px; height:60px; border-radius:18px; background: rgba(59,130,246,0.22); display:flex; align-items:center; justify-content:center; color:#dbeafe; font-size:1.35rem;">
                                <span class="fa fa-file-alt"></span>
                            </div>
                            <div>
                                <p style="margin:0; color:#bfdbfe; text-transform:uppercase; letter-spacing:0.2em; font-size:0.82rem;">Trámites en línea</p>
                        ...
                        <p style="margin:0; color:#dbeafe; font-size:1.03rem; line-height:1.85;">Accede a documentos oficiales, formularios y rendiciones con un solo clic. Todo el servicio digital pensado para tu comodidad.</p>
            ...
            <div class="col-xl-7">
                <div style="background:#ffffff; border-radius:36px; padding:2rem; box-shadow: 0 28px 68px rgba(15,23,42,0.15);">
                    <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem; margin-bottom:1.8rem;">
                        <div>
                            ...
                            <h3 style="margin:0.55rem 0 0; font-size:1.95rem; color:#0f172a; line-height:1.05;">Balcón de servicios y recursos</h3>
                        </div>
                        <span style="display:inline-flex; align-items:center; gap:0.55rem; color:#10b981; font-weight:700; font-size:0.95rem;">
